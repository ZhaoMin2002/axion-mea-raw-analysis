...
def read_raw(raw_path, well_shape=(6, 8), electrode_shape=(4, 4), start_end=None, channel_array_path=None, downsample=1):
    ...
    meta = {}
    meta['fs'] = float(fs[1].split(' ')[0]) / downsample  # 降采样调整
